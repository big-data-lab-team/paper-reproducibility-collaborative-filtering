...
% 3. rows
\paragraph{Complete rows} The training set is sampled by randomly
selecting complete rows in the matrix, that is, the first files in
...
% 4. random real
\paragraph{Random real}
\todo{Explain this better} This approach will select its next training set element according to
the next file turn in the next random selected subject.

% 5. random diagonal
\paragraph{Random diagonal}
