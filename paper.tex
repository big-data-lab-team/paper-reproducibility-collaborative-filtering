...
Figure~\ref{fig:ALS-Failure} represents
The accuracy graph of four diferent Complete Columns, RS, Complete Rows and Random Unreal methods.The comparision to dummy
classifier over the increasement of the training ratio can be seen in this figure.
\begin{figure}[h!]
        \centering
...
Dispite of this sudden mentioned drop to $78\%$ accuracy, RFNT-L method has slight growing trend throughout the 
...
In this phase of experiment, the variation in values of utility matrix which caused by subjects and files are also considered. 
Figure~\ref{fig:ALS-Bias-PFS} presents the result of three methods of RFNU, RFNT-L and RFNT-S with having a comparison with
Random Unreal method.
