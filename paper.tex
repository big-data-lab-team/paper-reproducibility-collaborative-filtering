...
\includegraphics[width=\columnwidth]{figures/5vs7_random-unreal_03_training}
  \caption{Sample training set obtained with the Random Unreal method with a training ratio of 0.3.}
...
\begin{figure}
  ...
  \caption{Sample training set obtained with the Complete Columns method with a training ratio of 0.3.}
...
\begin{figure}
  ...
  \caption{Sample training set obtained with the Complete Rows method with a training ratio of 0.3.}
...
\begin{figure}
 \includegraphics[width=\columnwidth]{figures/5vs7_random-real_03_training}
  \caption{Sample training set obtained with the Random Subjects method with a training ratio of 0.3.}
