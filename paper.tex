...
\textit{\textbf{b}} : The highest possibility of file index that could be selected for a subject which is equal to the maximum index file (total number of subject's files,Nf)\\
