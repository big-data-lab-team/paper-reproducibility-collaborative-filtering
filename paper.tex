...
\end{figure}
 ...
 \note{Soudabeh, add figure with two 3D plots showing the 3 factors of 
 every item and subject. Comment: the method indeed separates files in 
 3 blocks (for 8 types) and subjects in 8 types.}
