...
For training ratios greater or equal than 0.5, the accuracy obtained 
...
on the accuracy, presumably due to the low accuracy of the method.\todo{Soudabeh, check if the factors can be interpreted.}
...
\begin{figure}[h]
\includegraphics[width=0.9\columnwidth]{figures/5i-3f-ALS-r1-08-userFactors.pdf}
\caption{The three subject latent factor vectors from a matrix decomposition of the synthetic matrix of 8 subject types}
\label{fig:userfactors}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=0.9\columnwidth]{figures/5i-3f-ALS-r1-08-itemFactors.pdf}
