...
\includegraphics[width=\columnwidth]{figures/5vs7_random-unreal_04_training}
  \caption{Sample training set obtained with the Random Unreal method with a training ratio of 0.4.}
...
\begin{figure}
  ...
  \caption{Sample training set obtained with the Complete Columns method with a training ratio of 0.4.}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.4\linewidth}
  		...
  		\caption{Sample training set obtained with the Complete Rows method with a training ratio of 0.4.}
  		\label{fig:Rows-Sample-Training-set}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\linewidth}
 		\includegraphics[width=\columnwidth]{figures/5vs7_random-real_04_training}
		\caption{Sample training set obtained with the Random Subjects method with a training ratio of 0.4.}
  		\label{fig:Uniform-S-Sample-Training-set}
	\end{subfigure}
\end{figure}

\paragraph{Random Subjects} This method builds the 
...
\paragraph{Random File Numbers (Uniform)}
The 
number of files selected in every subject is randomly selected in a 
uniform distribution with parameters a and b where a and b are set as follows: \ldots{}
...
\begin{figure}
  ...
  \caption{Sample training set obtained with the Random File Numbers (Uniform) method with a training ratio of 0.4.}
  \label{fig:Diagonal-Sample-Training-set}
\end{figure}

\paragraph{Random File Numbers (Triangular)}
...
This ununiform distribution aims at sampling files produced towards the end of the execution.
Two approches are tried to apply this method:
\begin{enumerate}
\item Largest-a:  In this approach there is a concern to eliminate the possibility of having less \todo{Reformulate, this is unclear.}
...
\begin{figure}
  ...
  \caption{Sample training set obtained with the Random File Numbers (Triangular-L) method with a training ratio of 0.4.}
  \label{fig:triangular-L-Sample-Training-set}
\end{figure}
\item Smallest-a: In this approach of utilizing triangular distribution,despite of Largest-a approch, there is a possibility 
...
\begin{figure}
  ...
  \caption{Sample training set obtained with the Random File Numbers (Triangular-S) method with a training ratio of 0.4.}
...
Results show that in all condition pairs Complete Column method has 
almost a constant accuracy even if the training ratio increased and it 
is almost two times less than dummy accuracy in more differentiated 
condition pairs (CentOS5 vs CentOS7 and CentOS6 vs CentOS7). But in the 
best case which it means in similar conditions the Complete column 
accuracy is as much accurate as the Dummy accuracy is, $0.65$ 
percent. In general the accuracy pattern of the two complete Rows and 
Uniform-s methods show similar decline and grow behavior over the 
...
seemingly irrational behaviour, they always perform a better accuracy 
...
All the other random methods, Uniform-SF and both Triangular approaches 
are performing a continues groth. Although some considerable variation 
